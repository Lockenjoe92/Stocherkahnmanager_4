...
if($shallIlive == 'on'){
    ...
    if($anzahl>0) {
        ...
        //1. Schlüsselkram
        $AnfrageLadeAlleSchluesselausgaben = "SELECT * FROM schluesselausgabe WHERE storno_user IS NULL AND ausgabe IS NOT NULL AND rueckgabe IS NULL ORDER BY schluessel ASC";
